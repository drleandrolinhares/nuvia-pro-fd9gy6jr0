-- Atualiza a função para forçar a exclusão mútua e não contar Vendas/Avaliações como Leads ativos
...
-- Script de correção: remover duplicidades de Leads e forçar recálculo
DO $$
DECLARE
  r RECORD;
BEGIN
  -- Deduplica funil_leads (mantém o mais recentemente atualizado)
  FOR r IN (
  ...
  -- Recalcula os dados de todas as origens/meses afetados
