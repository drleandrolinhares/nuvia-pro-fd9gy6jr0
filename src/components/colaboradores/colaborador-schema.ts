...
export const colaboradorSchema = z
  .object({
    ...
    pode_realizar_lancamento: z.boolean().optional(),
    possui_carteira: z.boolean().optional(),
    exigir_rotina: z.boolean().optional(),
    obrigatorio_pp_pdm: z.boolean().optional(),
    elegivel_ferias: z.boolean().optional(),
    acesso_chat: z.boolean().optional(),
